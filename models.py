...
class DynamicValueDockerChallenge(BaseChallenge):
    ...
    templates = {  # Handlebars templates used for each aspect of challenge editing & viewing
        "create": "/plugins/ctfd-docker/assets/create.html",
        "update": "/plugins/ctfd-docker/assets/update.html",
        "view": "/plugins/ctfd-docker/assets/view.html",
    }
    scripts = {  # Scripts that are loaded when a template is loaded
        "create": "/plugins/ctfd-docker/assets/create.js",
        "update": "/plugins/ctfd-docker/assets/update.js",
        "view": "/plugins/ctfd-docker/assets/view.js",
    }
    # Route at which files are accessible. This must be registered using register_plugin_assets_directory()
    route = "/plugins/ctfd-docker/assets/"
    # Blueprint used to access the static_folder directory.
    blueprint = Blueprint(
        "ctfd-docker-challenge",
        __name__,
...
class DynamicDockerChallenge(Challenges):
    ...
    redirect_port = db.Column(db.Text, default="80/tcp")
